...
export default function AddGroceryItem({ onAdd, categories, supermarkets }: Props) {
  ...
  return (
    <div className={`relative mb-8 overflow-hidden rounded-[2.5rem] border transition-all duration-500 ${isFocused ? 'border-emerald-500 shadow-2xl shadow-emerald-500/10' : 'border-zinc-200'}`}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-6 items-end">
          ...
          <div className="md:col-span-2 lg:col-span-5 space-y-2.5">
            ...
            <div className="relative group">
              ...
              <input
                ...
                placeholder="Nombre"
                className="h-16 w-full rounded-2xl border-2 border-zinc-100 bg-zinc-50 pl-12 pr-4 text-base font-bold text-zinc-900 outline-none transition-all focus:border-emerald-500/50 focus:bg-white"
              />
            </div>
          </div>
          ...
          <div className="lg:col-span-3 space-y-2.5">
            ...
            <div className="relative group">
              ...
              <select
                ...
                className="h-16 w-full appearance-none rounded-2xl border-2 border-zinc-100 bg-zinc-50 pl-12 pr-10 text-base font-bold text-zinc-900 outline-none transition-all focus:border-emerald-500/50 focus:bg-white cursor-pointer"
              >
          ...
          <div className="lg:col-span-1">
            <button
              ...
              className="h-16 w-full rounded-2xl bg-zinc-900 font-black text-xs uppercase tracking-widest text-white transition-all transform hover:scale-[1.05] active:scale-95 disabled:opacity-30 disabled:grayscale shadow-xl shadow-zinc-900/10"
            >
